...
This is a quick-reference for the 20 most important `.env` variables in Tina4 Ruby. For the complete reference of all 79 variables, see **Book 0: Understanding Tina4, Chapter 4**.
