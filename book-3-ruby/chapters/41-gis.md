...
`PointField` maps to `geography(Point,4326)` and creates a GiST index. Unsupported databases fail clearly. `Tina4::Point.parse` accepts coordinate pairs, WKT/EWKT, GeoJSON, or WKB/EWKB and never guesses coordinate order.
