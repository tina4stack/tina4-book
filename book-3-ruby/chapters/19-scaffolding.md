...
| # | File | Purpose |
|---|------|---------|
| 1 | `src/orm/product.rb` | ORM model with typed fields |
...
| 4 | `src/routes/products.rb` | CRUD routes with Swagger annotations |
...
| 7 | `spec/products_spec.rb` | RSpec stubs for all CRUD operations |
...
| 7 | `spec/auth_spec.rb` | Auth flow tests |
